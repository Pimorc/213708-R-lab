...
```{r summary-data, echo=TRUE, message=FALSE, warning=FALSE, tab.cap="Summary of experiment data for ANOVA", results='asis'}
summary_plant%>%
  kbl(align = "c",
...
```{r tukey-hsd-tab, message=FALSE, echo = TRUE, tab.cap= "Tukey's HSD results comparing three treatment pairs", warning=FALSE, results='asis'} 
...
```{r summary-data-ancova, echo=TRUE, message=FALSE, warning=FALSE, tab.cap="Summary of fertilizer experiment data by treatment", results='asis'}
summary_stats %>%
  kbl(align = "c",
...
```{r effect-size-ancova, tab.cap="Partial eta-squared of ANCOVA model of the fertilizer experiment", echo =TRUE, warning=FALSE, message=FALSE, results='asis'}
library(effectsize)
