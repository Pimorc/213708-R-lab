...
We will usse a number of packages in this lab, including `ggplot2` [@ggplot2], `dplyr` [@dplyr], `ggthemes` [@ggthemes], `kableExtra` [@kableextra], `DescTools` [@DescTools], `emmeans` [@emmeans], `multcomp`[@multcomp], and `effectsize` [@effectsize].
