...
Every time we make a statistical decision, we can potentially make an error [@navarro2023]. There are two types of errors (Table 8.1):
...
This error means failing to reject $H_0$ when $H_1$ is true. This is analogous to a guilty person escaping conviction (Table 8.2).
