...
kable(error_table,
  ...
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"),
               ...
               position = "left",
               font_size = 14) %>%
  column_spec(1, width = "8em", border_right = TRUE, background = "white") %>%
  column_spec(2, width = "15em", background = c("white", "white", "white", "#FFE6CC")) %>%
  column_spec(3, width = "15em", c("white", "white", "#FFE6CC", "white")) %>%
  #row_spec(0, bold = TRUE, background = c("white", "white","#FFE6CC")) %>%
  #row_spec(1, background = c("white", "white","#FFE6CC")) %>%
  #row_spec(2, background = c("white", "#FFE6CC", "white")) %>%
...
: (#tab:error-type-analog) Criminal trial analogy of error types
