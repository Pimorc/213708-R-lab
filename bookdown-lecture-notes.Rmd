...
```{r pairs-plot, echo=FALSE, fig.cap="Pairs plot of four selected seed traits coloured by species (($\\circ$) = C. caudatum, $\\ast$ = E. subumbrans, and $\\square$ = G. cowa). Pairs of traits that show good group separation in bivariate scatter are strong discriminators.", fig.height=6, fig.width=7, message=FALSE, warning=FALSE}
species_cols <- c(
  "C. caudatum"  = "#F8766D",
  "E. subumbrans" = "#00BA38",
  "G. cowa"        = "#619CFF"
