...
```{r ancova-data-tab, echo=FALSE, message=FALSE, warning=FALSE, tab.cap="The data of fertilizer experiment for ANCOVA"}
### Write the data into a table
library(knitr)
library(kableExtra)
...
```{r comparison, echo =FALSE, message=FALSE, warning=FALSE, tab.cap="Comparisons fo F statistics and P-value of ANOVA and ANCOVA", include=FALSE}
