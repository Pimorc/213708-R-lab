...
---
# Multivariate Analysis and Principal Component Analysis (PCA)
...
A classic example is the Iris dataset (Anderson 1935, published by Fisher 1936), which contains four morphological measurements — petal width, petal length, sepal width, and sepal length — for 150 specimens across three *Iris* species. No single variable cleanly separates the species, but multivariate analysis can reveal the underlying structure effectively.
...
**Ordination** is the process of ordering or arranging sampling units along axes that represent major gradients of variation in the data. Rather than working in a high-dimensional space with many variables, ordination reduces the data to two or three summary axes that capture the most important patterns.
...
**Principal Component Analysis (PCA)** is one of the most widely used exploratory multivariate techniques. It was introduced by Karl Pearson in 1901 in his paper *"On Lines and Planes of Closest Fit to Systems of Points in Space"* and further developed by Harold Hotelling in the 1930s.
