...
```{r die-pmf, echo=TRUE, fig.cap="PMF of rolling a die.", fig.width=6, fig.height=4}
...
barplot(prob, names.arg = x, 
        ...
        main = "Probability Mass Function of Rolling a Die",
        col = "steelblue",
        ylim = c(0, 0.2))
```
...
```{r height-pdf, echo=TRUE, fig.cap="PDF of height measurement of students.", fig.width=7, fig.height=5}
...
```{r die-running-avg, echo=TRUE, fig.cap="Running average of rolling a die 1000 times and the expected value.", fig.width=7, fig.height=5}
...
```{r variance-example, echo=TRUE, fig.cap="An example of 10 data points of cat's height and the mean.", fig.width=7, fig.height=5}
