...
In this step. It is good practice to compute measures of central tendency and spread (see topics 5.3 and 5.4 for more details).

**Step 6: Visualize data**

In this step, plots are made to see patterns of data and/or to see relationships between data. (see topics 5.5 for more details).
...
**Ordinal Data:** Categorical data with a meaningful order but without a fixed interval between values
...
**Ratio Data:** Numerical data where both differences and ratios are meaningful, and a true zero exists
...
**Data attribute of the Iris data set**
...
```{r rose1, echo = FALSE, fig.cap="A data set of seven roses with a mean, median, and mode", out.width="80%"}
...
The most frequently occurring value. From the example of roses (Figure 5.2), the mode of rose height is 6.5 because there are four data points with the value of 6.5 inches.
...
Measures of spread helps to understand how data values are spread out from the center (Figure 5.3). Key measures include:
...
```{r rose2, echo = FALSE, fig.cap="A data set of seven roses with a measures of spread", out.width="80%"}
# Placeholder for Figure
...
```{r hist, echo = FALSE, fig.cap="Histogram of sepal length data in the iris data set (Fisher 1936). The frequency on the y-axis and the sepal length data in centimeters on the x-axis. The curve is kernel smoothing for probability density estimation to show overall shape of the distribution", out.width="80%"}
# Placeholder for Figure
...
The plots (also called box-and-whisker plots) summarize data distributions by showing key statistics such as the median, quartiles (Q1 and Q3), and potential outliers. The box represents (Figure 5.7) the interquartile range (IQR), while the "whiskers" extend to the smallest and largest values within a reasonable range. Any points beyond the whiskers are considered outliers. Box plots are particularly useful for comparing multiple datasets and identifying skewness.

![Boxplot of sepal length data in the iris data set](figures/figure_5_7.png)
*Figure 5.7 Boxplot of sepal length data in the iris data set (Fisher 1936)*
...
![Q-Q plot of sepal length data in the iris data set](figures/figure_5_8.png)
*Figure 5.8 Q-Q plot of sepal length data in the iris data set (Fisher 1936). The data are on the y-axis and the theoretical quantiles of normal distribution is on the x-axis. A straight diagonal red line indicates the expected normal distribution*

### Scatter plots

They are used to visualize the relationship between two numerical variables by plotting points on a coordinate plane (Figure 5.9). If the points form a clear pattern (such as a rising or falling trend), it suggests a correlation between the variables. Scatter plots are commonly used in regression analysis to examine how one variable influences another.

![Scatter plot of sepal length and petal length of the iris data set](figures/figure_5_9.png)
*Figure 5.9 Scatter plot of sepal length (x axis) and petal length (y axis) of the iris data set (Fisher 1936)*
...
From the example of iris' sepal length (cm) and petal length (cm) (Figure 5.9) the covariance of the two variables is 1.27. The positive covariance means that the sepal and petal length move in the same direction.
...
From the example of iris' sepal length (cm) and petal length (cm) (Figure 5.9), the Pearson's correlation coefficient of the two variables is 0.87. This positive coefficient value indicates strong correlations between the two variables. It is to remember that "correlation does not imply causation". The idea that ones should not interpret correlation as causation is originated by Karl Pearson. The phrase is popularized overtime by various books e.g. Huff 1954.
