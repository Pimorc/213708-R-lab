...
d2 <- c(d[1:2], 200, 600, d[3:4]) ## add 200, 600
d2
```
...
**1**.
Given a right triangle with sides x = 5 and y = 13, calculate the length of the hypotenuse

**2**.
Generate a sequence of values from -4.8 to -3.43 that is length 8 (show code)

**3**.
What is the sum of the exponentials of this sequence?

**4**.
Create a character vector and name it as you wish.
The vector consists of 3 elements -- name, last name and month that you were born.

**5**.
Add your nickname behind your last name.
