...
R is software for statistical computing and graphics [@R-base]. R is free to use and when you use it in your publications, simply cite the software:
...
Data from experiments are valuable and needed to be analyzed to gain useful information for making scientifically sound decision and communicate the findings (Figure \@ref(fig:relationship)). The R programming language is a powerful tool for cleaning, visualizing, and analyzing data. There are many tools to do so, but the R programming language is free, flexible, and able to make beautiful figures for publication.
...
A function is a block of code that performs some tasks (Figure \@ref(fig:functions)). For data analyses, you write several functions that work together. In R, functions include built-in functions and user-defined functions. To write a function, you include this following:
...
This is a common data type for names. Writing character vectors will have to use "...". You may use either of '...' or "...". To create a character vector, you will use the function c(), or you may use paste():
