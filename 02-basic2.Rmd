# Lab 2 Scientific methods, role of experimental design and statistics in ecological and environmental studies (Data import and management {#basic2}
...
Then we save them in a .txt or .csv before importing them into R.

```{r relationship, echo = FALSE, fig.cap = "Save the data as .txt or .csv file", out.width="100%"}
knitr::include_graphics("figures/Lab 2 data.jpg")
```

## Data Input from files

**Data file:** [Click here to download the file](https://o365cmu-my.sharepoint.com/:t:/g/personal/pimonrat_t_cmu_ac_th/EQzNo6jjdE5IkDMjUS7PYlMBr3zp0Fd9cBHh1gthjY1BpQ?e=e0zL5v "Click to download the file")
...
**Data file:** [Click here to download the file](https://o365cmu-my.sharepoint.com/:x:/g/personal/pimonrat_t_cmu_ac_th/ESyrKa6iihVHkMCVRQUFes4BFLfeRY_Q79fXhTAxy6Wc0A?e=z7ET6c "Click to download the file")
...
**3**.  In R, create a data frame in R named ‘data’, and then import a file ‘example.txt’.
    Show the data frame.
